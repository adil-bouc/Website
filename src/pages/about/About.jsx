    ...
    <ReactLenis root>
      <div className="page about">
        ...
        <section className="about-us">
          <div className="about-us-col">
            <div className="sign-up-card">
              ...
              <div className="sign-up-card-header">
                <h3>
                  Rejoignez la famille Juston Records !
                </h3>
          ...
          <div className="about-us-col">
            <h3>
              En tant que label indépendant, notre mission est de découvrir et développer 
              les talents de demain dans un esprit familial et professionnel.
            </h3>
            <p>
              Chez Juston Records, nous accompagnons nos artistes dans leur développement 
              artistique avec passion et expertise. Notre équipe expérimentée s'engage à 
              offrir un environnement créatif propice à l'épanouissement musical.
            </p>
        ...
        <section className="team">
          ...
          <div className="team-header">
            <h3>L'Équipe</h3>
            <h1>Juston Records</h1>
            <div className="join-team-card">
              <h3>Rejoignez l'Aventure</h3>
              <p>
                Chez Juston Records, nous valorisons la créativité et l'innovation 
                dans une ambiance collaborative et dynamique.
              </p>
